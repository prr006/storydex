...
export function storyAccentVars(seed: string): CSSProperties {
  ...
  return {
    ...
    '--story-accent-deep': `hsl(${h} 68% 34%)`,
    '--story-accent-soft': `hsl(${h} 75% 55% / 0.12)`,
    '--story-accent-line': `hsl(${h} 70% 45% / 0.45)`,
    '--story-glow': `hsl(${h} 95% 55% / 0.35)`,
    '--story-accent-ink': `hsl(${h} 40% 97%)`,
    '--story-sky': `hsl(${h} 65% 58% / 0.14)`,
    '--story-haze': `hsl(${h} 60% 55% / 0.07)`,
    '--story-light': `hsl(${h} 95% 72% / 0.5)`,
  } as CSSProperties
}
